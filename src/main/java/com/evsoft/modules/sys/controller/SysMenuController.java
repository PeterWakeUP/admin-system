...
import com.evsoft.common.utils.Constant.MenuType;
...
import com.evsoft.modules.sys.service.SysMenuService;
...
public class SysMenuController extends AbstractController {
    ...
    public R save(@RequestBody SysMenuEntity menu) {
        ...
        try {
            ...
            logger.error("菜单配置失败{}", ex.getMessage());
            return R.error("菜单配置失败");
        }
    }
