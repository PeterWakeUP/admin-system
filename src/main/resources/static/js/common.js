...
var jstxbaseurl = "http://jishi.yinliancn.com";
...
//弹出模式对话框(双按钮) created by wangzh 2018/04/18
...
//弹出模式对话框（单个按钮） created by wangzh 2018/04/27
...
function getRowData(rowId){
    return rowData = $("#jqGrid").jqGrid('getRowData',rowId);
}
